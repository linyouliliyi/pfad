...
def show_pause_menu():
    ...
    restart_image = pygame.image.load('assets/btn_re.jpg')
    continue_image = pygame.image.load('assets/btn_con.jpg')
    quit_image = pygame.image.load('assets/btn_quit.jpg')
...
def show_start_menu():
    ...
    start_image = pygame.image.load('assets/btn_start.jpg') 
...
def show_instructions():
    ...
    ok_image = pygame.image.load('assets/btn_ok.jpg')
...
def main_game_loop():
    ...
    click_sound = pygame.mixer.Sound("assets/ring.mp3") 
    ...
    while running:
        ...
        # Draw pause button
        pause_button = pygame.Rect(10, 50, 100, 50)
        pause_image = pygame.image.load('assets/btn_pause.jpg')
